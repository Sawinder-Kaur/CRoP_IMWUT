...
input_tensor = torch.randn(76, 5, 60,dtype=torch.float32)
labels = torch.randint(0, 2, (76,), dtype=torch.long)
...
for i in range(5):
    ...
    trials.append([infer_end-infer_start, infer_energy, infer_memory_info,infer_percent])
...
# print_training_stats(train_end2-train_start, (train_energy+train_energy2)//2, (train_memory_info+train_memory_info2)//2,(avg_percent+avg_percent2)//2,'Training')
